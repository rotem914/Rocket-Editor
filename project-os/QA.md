...
| App code | Run the project checks. They must pass, not "mostly pass". |
...
Any change a person can see or operate is verified in the running app, at the address in the table at the top of `CLAUDE.md`.
...
| `Tested` | `Ran the project checks; passed. Loaded the page; no console errors.` |
...
- [ ] Project checks run and passing.
