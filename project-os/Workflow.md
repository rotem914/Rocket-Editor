...
Run what the change deserves. Typically the project's own check command, plus whatever else applies: build, typecheck, lint, unit tests, a smoke run, a request against the API, a schema validation, a write-then-read test.
